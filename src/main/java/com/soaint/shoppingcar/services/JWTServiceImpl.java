...
import com.soaint.shoppingcar.auth.SimpleGrantedAuthorityMixin;
...
public class JWTServiceImpl implements JWTService {
	...
	public static final String SECRET = Base64Utils.encodeToString("applaudo.test.java".getBytes());
